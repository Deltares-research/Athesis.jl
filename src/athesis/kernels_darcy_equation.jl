...
@inline function darcy_kernel!(i, j, source, h, u, v, hⁿ⁺¹, uⁿ⁺¹, vⁿ⁺¹, Δx::Float64, Δy::Float64, Δt::Float64, K)
...
@inline function darcy_kernel!(i, j, k, source, h, u, v, w, hⁿ⁺¹, uⁿ⁺¹, vⁿ⁺¹, wⁿ⁺¹, Δx::Float64, Δy::Float64, Δz::Float64, Δt::Float64, K)
    # 3D implementation
